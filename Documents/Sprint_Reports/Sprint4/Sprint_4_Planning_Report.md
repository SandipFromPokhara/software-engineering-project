...
The goal of Sprint 4 is to finalize the NoteVault prototype, ensure all functionalities operate correctly, and prepare the project for final deployment and demonstration.

During this sprint, the team will verify system stability through testing and debugging, containerize the application for deployment, publish the Docker image to Docker Hub, and test the deployed application in a suitable environment.

In addition, the team will finalize project documentation, update the GitHub repository, and prepare the final presentation for demonstrating the system to classmates and the instructor.

By the end of Sprint 4, the team aims to deliver a fully deployable prototype with proper documentation and a successful demonstration of the system.
...
The following Product Backlog items were selected for Sprint 4:

| Task | Story Points |
|-----|-----|
| Final system testing and bug fixing | 4 |
| Docker image deployment and verification | 3 |
| Publish Docker image to Docker Hub | 2 |
| Deployment testing | 3 |
| Documentation update (README, architecture) | 2 |
| Prepare final presentation | 3 |
| Prototype demonstration and feedback | 2 |
...
**Capacity:** 4 members × 4 hours/day × 7 days = about **112 hours**

**Assumptions:**  
Since most technical features were implemented during Sprint 3, the primary focus of Sprint 4 will be on testing, deployment verification, documentation, and presentation preparation.
