...
class UserServiceTest {
    ...
    @Test
    void testLoginCorrectPasswordReturnsUser() {
        UserEntity user = new UserEntity();
        user.setUsername("user");
